...
begin
 ...
 rt_info.SHADERDATA.SPI_SHADER_Z_FORMAT     :=GPU_REGS.CX_REG^.SPI_SHADER_Z_FORMAT     ;
 rt_info.SHADERDATA.SPI_SHADER_COL_FORMAT   :=GPU_REGS.CX_REG^.SPI_SHADER_COL_FORMAT   ;
 ...
 rt_info.SHADERDATA.PA_CL_VS_OUT_CNTL       :=GPU_REGS.CX_REG^.PA_CL_VS_OUT_CNTL       ;
