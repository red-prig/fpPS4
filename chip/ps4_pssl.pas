...
const
 ...
 BUFFER_ATOMIC_FCMPSWAP   =$3e;
 BUFFER_ATOMIC_FMIN       =$3f;
 BUFFER_ATOMIC_FMAX       =$40;
 ...
 BUFFER_ATOMIC_FCMPSWAP_X2=$5e;
 BUFFER_ATOMIC_FMIN_X2    =$5f;
 BUFFER_ATOMIC_FMAX_X2    =$60;
...
var
 ...
 begin
  case SPI.MUBUF.OP of
   ...
   BUFFER_ATOMIC_FCMPSWAP_X2:Result:=2;
   BUFFER_ATOMIC_FMIN_X2    :Result:=2;
   BUFFER_ATOMIC_FMAX_X2    :Result:=2;
   else
    Result:=1;
  end;
 end;
...
begin
 case SPI.MUBUF.OP of
  ...
  BUFFER_ATOMIC_FCMPSWAP   :str:='BUFFER_ATOMIC_FCMPSWAP';
  BUFFER_ATOMIC_FMIN       :str:='BUFFER_ATOMIC_FMIN';
  BUFFER_ATOMIC_FMAX       :str:='BUFFER_ATOMIC_FMAX';
  ...
  BUFFER_ATOMIC_FCMPSWAP_X2:str:='BUFFER_ATOMIC_FCMPSWAP_X2';
  BUFFER_ATOMIC_FMIN_X2    :str:='BUFFER_ATOMIC_FMIN_X2';
  BUFFER_ATOMIC_FMAX_X2    :str:='BUFFER_ATOMIC_FMAX_X2';
