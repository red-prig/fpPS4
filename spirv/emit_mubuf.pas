...
begin
 case FSPI.MUBUF.OP of
  ...
  BUFFER_ATOMIC_SMIN      : emit_BUFFER_ATOMIC(1,BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_SINT,Op.OpAtomicSMin);
  BUFFER_ATOMIC_SMAX      : emit_BUFFER_ATOMIC(1,BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_SINT,Op.OpAtomicSMax);

  BUFFER_ATOMIC_UMIN      : emit_BUFFER_ATOMIC(1,BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_UINT,Op.OpAtomicUMin);
  BUFFER_ATOMIC_UMAX      : emit_BUFFER_ATOMIC(1,BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_UINT,Op.OpAtomicUMax);
