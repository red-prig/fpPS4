...
Const
 ...
 SCE_SAVE_DATA_MOUNT_STATUS_CREATED    =1;

 SCE_SAVE_DATA_MOUNT_MAX_COUNT         =16;
 SCE_SAVE_DATA_DIRNAME_MAX_COUNT       =1024;
 ...
 SCE_SAVE_DATA_MEMORY_SETUP_MAX_COUN   =4;
 SCE_SAVE_DATA_MEMORY_DATANUM_MAX_COUNT=5;
 ...
 SDET_UMOUNT_BACKUP_END        =1;
 SDET_BACKUP_END               =2;
 SDET_SAVE_DATA_MEMORY_SYNC_END=3;
